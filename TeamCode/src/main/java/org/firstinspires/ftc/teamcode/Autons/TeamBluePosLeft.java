//For use when we are on the blue alliance and on the left side of the field.
//Blue terminal is to the top left
//THIS AUTON IS UNTESTED
...
@Autonomous()
public class TeamBluePosLeft extends LinearOpMode {
