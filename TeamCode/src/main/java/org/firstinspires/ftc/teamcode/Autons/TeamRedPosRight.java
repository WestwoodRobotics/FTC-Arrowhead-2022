//For use when we are on the red alliance and on the right side of the field.
//Red terminal is to the top right
...
@Autonomous()
public class TeamRedPosRight extends LinearOpMode {
